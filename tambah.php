...
if(isset($_POST['submit'])){
	...
	mysqli_query($conn, "INSERT INTO data_siswa VALUES (null, '$nama', '$email', '$telp')");
      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card border-0 shadow rounded-3 my-5">
          <div class="card-body p-4 p-sm-5">
            <h4 class="card-title text-center mb-5 fs-5">Halaman Tambah Data</h4>
            ...
            <form action="" method="post">
              ...
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingPassword" placeholder="Telp" name="telp">
                <label for="floatingPassword">Nomor Telepon</label>
              </div>

              <div class="d-grid">
                <button class="btn btn-primary btn-login text-uppercase fw-bold" type="submit" name="submit">Tambah Data</button>
              </div>
